...
ImageToolbox.prototype._setUp = function (contents) {
	...
	// Subscribe ROS map button.
	var loadRosMapBtn = this._element.querySelector('#loadRosMapBtn');
	loadRosMapBtn.addEventListener('click', function (e) {
		uploadInput.click();
	}, false);

	// Publish ROS map button.
	var pubRosMapBtn = this._element.querySelector('#pubRosMapBtn');
	pubRosMapBtn.addEventListener('click', function (e) {
		uploadInput.click();
	}, false);
